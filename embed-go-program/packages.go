...
//go:build darwin && go1.17 && !go1.18
// +build darwin,go1.17,!go1.18
...
func init() {
	...
	// "debug/elf"
	decs = make(native.Declarations, 1344)
	...
	decs["ELFMAG"] = native.UntypedStringConst("\u007fELF")
	...
	decs = make(native.Declarations, 82)
	decs["Attribute"] = reflect.TypeOf((*color_.Attribute)(nil)).Elem()
	decs["BgBlack"] = color_.BgBlack
	decs["BgBlue"] = color_.BgBlue
	decs["BgCyan"] = color_.BgCyan
	decs["BgGreen"] = color_.BgGreen
	decs["BgHiBlack"] = color_.BgHiBlack
	decs["BgHiBlue"] = color_.BgHiBlue
	decs["BgHiCyan"] = color_.BgHiCyan
	decs["BgHiGreen"] = color_.BgHiGreen
	decs["BgHiMagenta"] = color_.BgHiMagenta
	decs["BgHiRed"] = color_.BgHiRed
	decs["BgHiWhite"] = color_.BgHiWhite
	decs["BgHiYellow"] = color_.BgHiYellow
	decs["BgMagenta"] = color_.BgMagenta
	decs["BgRed"] = color_.BgRed
	decs["BgWhite"] = color_.BgWhite
	decs["BgYellow"] = color_.BgYellow
	decs["Black"] = color_.Black
	decs["BlackString"] = color_.BlackString
	decs["BlinkRapid"] = color_.BlinkRapid
	decs["BlinkSlow"] = color_.BlinkSlow
	decs["Blue"] = color_.Blue
	decs["BlueString"] = color_.BlueString
	decs["Bold"] = color_.Bold
	decs["Color"] = reflect.TypeOf((*color_.Color)(nil)).Elem()
	decs["Concealed"] = color_.Concealed
	decs["CrossedOut"] = color_.CrossedOut
	decs["Cyan"] = color_.Cyan
	decs["CyanString"] = color_.CyanString
	decs["Error"] = &color_.Error
	decs["Faint"] = color_.Faint
	decs["FgBlack"] = color_.FgBlack
	decs["FgBlue"] = color_.FgBlue
	decs["FgCyan"] = color_.FgCyan
	decs["FgGreen"] = color_.FgGreen
	decs["FgHiBlack"] = color_.FgHiBlack
	decs["FgHiBlue"] = color_.FgHiBlue
	decs["FgHiCyan"] = color_.FgHiCyan
	decs["FgHiGreen"] = color_.FgHiGreen
	decs["FgHiMagenta"] = color_.FgHiMagenta
	decs["FgHiRed"] = color_.FgHiRed
	decs["FgHiWhite"] = color_.FgHiWhite
	decs["FgHiYellow"] = color_.FgHiYellow
	decs["FgMagenta"] = color_.FgMagenta
	decs["FgRed"] = color_.FgRed
	decs["FgWhite"] = color_.FgWhite
	decs["FgYellow"] = color_.FgYellow
	decs["Green"] = color_.Green
	decs["GreenString"] = color_.GreenString
	decs["HiBlack"] = color_.HiBlack
	decs["HiBlackString"] = color_.HiBlackString
	decs["HiBlue"] = color_.HiBlue
	decs["HiBlueString"] = color_.HiBlueString
	decs["HiCyan"] = color_.HiCyan
	decs["HiCyanString"] = color_.HiCyanString
	decs["HiGreen"] = color_.HiGreen
	decs["HiGreenString"] = color_.HiGreenString
	decs["HiMagenta"] = color_.HiMagenta
	decs["HiMagentaString"] = color_.HiMagentaString
	decs["HiRed"] = color_.HiRed
	decs["HiRedString"] = color_.HiRedString
	decs["HiWhite"] = color_.HiWhite
	decs["HiWhiteString"] = color_.HiWhiteString
	decs["HiYellow"] = color_.HiYellow
	decs["HiYellowString"] = color_.HiYellowString
	decs["Italic"] = color_.Italic
	decs["Magenta"] = color_.Magenta
	decs["MagentaString"] = color_.MagentaString
	decs["New"] = color_.New
	decs["NoColor"] = &color_.NoColor
	decs["Output"] = &color_.Output
	decs["Red"] = color_.Red
	decs["RedString"] = color_.RedString
	decs["Reset"] = color_.Reset
	decs["ReverseVideo"] = color_.ReverseVideo
	decs["Set"] = color_.Set
	decs["Underline"] = color_.Underline
	decs["Unset"] = color_.Unset
	decs["White"] = color_.White
	decs["WhiteString"] = color_.WhiteString
	decs["Yellow"] = color_.Yellow
	decs["YellowString"] = color_.YellowString
	packages["github.com/fatih/color"] = native.Package{
		Name:         "color",
		Declarations: decs,
	}
	// "go/ast"
	...
	// "reflect"
	decs = make(native.Declarations, 71)
